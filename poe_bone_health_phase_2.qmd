...
```{r}
library(pacman)
p_load(magrittr, tidyverse, psych, dplyr, ggplot2, haven, janitor, readxl, writexl, knitr, kableExtra, scales, tibble, tidyr, patchwork, ggrepel, zoo)
```
...
# Drug pricing
 ...
 # Uptake & market penetration
  ...
  "Approx. 5% per year (logistic ramp)",
  "Modeled assumption",
  ...
  "Modeled assumption",
  "Consistent with observed maximum penetration for osteoporosis treatments in the US; prevents unrealistic over-adoption.",
